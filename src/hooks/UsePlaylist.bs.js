  ...
  if (typeof action === "number") {
    if (action !== 0) {
      return {
              ...
              currentSongIndex: (state.currentSongIndex + 1 | 0) === Caml_array.caml_array_get(state.mergedPlaylist, state.currentBatchIndex).length ? 0 : state.currentSongIndex + 1 | 0,
